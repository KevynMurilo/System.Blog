...
public static class EmailTemplates
{
    ...
    public static string GeneratePasswordResetEmailBody(string resetCode, string name)
    {
        return $@"
        <html>
        <head>
        ...
        <body>
            <div class='container'>
                ...
                <div class='content'>
                    <p>Olá {name},</p>
                    <p>Recebemos uma solicitação para redefinir a senha da sua conta. Para prosseguir, utilize o código de redefinição de senha abaixo:</p>
